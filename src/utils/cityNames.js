const data = {
  ...
  "خراسان جنوبی": ["بيرجند", "سربيشه", "فردوس", "قائن", "نهبندان"],
  "خراسان رضوی": [
    "تايباد",
    "تربت جام",
    "تربت حيدريه",
  ...
  "خراسان شمالی": ["آشخانه", "اسفراين", "بجنورد", "جاجرم", "شيروان"],
  خوزستان: [
    "آبادان",
    "انديمشك",
    "اهواز",
  ...
  مرکزی: ["آشتيان", "اراک", "تفرش", "خمين", "دليجان", "ساوه", "شازند", "محلات"],
  هرمزگان: [
    "بستک",
    "بندر جاسک",
    "بندر خمیر",
...
const provincesList = Object.entries(data);
